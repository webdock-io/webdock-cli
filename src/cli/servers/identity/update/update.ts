...
export const updateserverIdentity = new Command()
    ...
    .option("--removeDefaultAlias <removeDefaultAlias:boolean>", "If true, remove the default Webdock alias from DNS. Warning: phpMyAdmin and other services may become inaccessible if your main domain has DNS issues.", { default: true })
