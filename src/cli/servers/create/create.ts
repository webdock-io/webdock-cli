...
export const createCommand = new Command()
	...
	.option("-i, --imageSlug <imageSlug:string>", "Slug identifier of the server image",)
	...
	.option("-a, --snapshotId <snapshotId:number>", "Optional snapshot ID to restore the server from",)
